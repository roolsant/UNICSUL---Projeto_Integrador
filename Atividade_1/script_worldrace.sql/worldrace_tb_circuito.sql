...
CREATE TABLE `tb_circuito` (
  ...
  `nm_circuito` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `nr_extensao` decimal(6,3) NOT NULL,
  `tb_Pais_idpais` int NOT NULL,
  PRIMARY KEY (`idcircuito`),
  KEY `fk_tb_Circuito_tb_Pais1_idx` (`tb_Pais_idpais`),
  CONSTRAINT `fk_tb_Circuito_tb_Pais1` FOREIGN KEY (`tb_Pais_idpais`) REFERENCES `tb_pais` (`idpais`)
